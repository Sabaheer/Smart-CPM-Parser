...
ULD = GrammarDesc("ULD",
       [MatchField(MatchField.MATCH_FIELD_MANDATORY, "m(m)(m)", "ULDBayDesignation", precede_separator="-", depends_on=["LoadCategory", "VolumeCode"], new_res=True),
            ...
            MatchField(MatchField.MATCH_FIELD_CONDITIONAL, "f(f)(f)(f)(f)", "Weight",  precede_separator="/", depends_on=["UnloadingStation", "LoadCategory", "ULDBayDesignation", "ULDTypeCode"]),
